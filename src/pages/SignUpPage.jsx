      ...
      >
        ...
        <div className="glass-card p-8 border-slate-700/50 shadow-2xl">
          <div className="text-center mb-10">
            ...
            <p className="text-slate-400">Join the next-gen AI interview platform</p>
          </div>
          ...
          <p className="text-center text-slate-400 mt-8 text-sm">
            Already have an account? <Link to="/signin" className="text-brand-400 hover:text-brand-300 font-medium">Sign in</Link>
          </p>
        </div>
      </motion.div>
    </div>
