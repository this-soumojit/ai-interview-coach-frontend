...
export default function UploadPage() {
  ...
  function handleStartInterview() {
    if (sessionId)
      navigate(`/interview/${sessionId}?questions=${questionCount}`);
  }

  return (
    <div className="min-h-screen bg-[#030712] pt-20 sm:pt-24 pb-14 sm:pb-20 px-4 flex items-start justify-center relative overflow-hidden">
      {/* Glow */}
      ...
      <div className="relative z-10 w-full max-w-lg mt-4 sm:mt-8">
        {/* Header */}
        <div className="text-center mb-10">
          ...
          >
            ...
            <p className="text-slate-500 text-sm max-w-xs mx-auto leading-relaxed">
              We'll read your background and generate questions tailored
              specifically to you.
            </p>
          </motion.div>
        </div>
        ...
        <motion.div
          ...
          className="bg-slate-900/60 border border-slate-800 rounded-2xl p-5 sm:p-8 backdrop-blur-sm flex flex-col gap-6"
        >
          {/* Dropzone */}
          <div>
                  ...
                  ({
                    ...
                    return (
                      ...
                      >
                        <Icon
                          size={22}
                          className={selected ? color : "text-slate-500"}
                        />
                        <span
                          className={`text-sm font-bold font-heading ${selected ? "text-white" : "text-slate-400"}`}
                        >
                          {label}
                        </span>
                        <span
                          className={`text-xs ${selected ? "text-slate-300" : "text-slate-600"}`}
                        >
  ...
  return (
    <div className="w-full">
      ...
      >
        ...
        >
          {acceptedFile ? <FileCheck2 size={28} /> : <UploadCloud size={28} />}
        </div>
